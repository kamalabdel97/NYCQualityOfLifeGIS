...
ggsave("/Users/kamal/Documents/untitled folder/test.png",
...
dpi = 300, units = "in", bg = "transparent")
   ...
   ggplot() + geom_sf(data = NycComIncome, aes(fill = NycComIncome$Data))+
   ...
   ggsave("/Users/kamal/Documents/GitHub/NYCQualityOfLifeGIS/QQ Norms/IncomeQQ.png",
      ggplot(NYCIncome, aes(sample = Data)) +
         stat_qq() +
         stat_qq_line() +
         theme(axis.title.x=element_blank(),
            axis.text.x = element_blank(),
   ...
   ggsave("/Users/kamal/Documents/GitHub/NYCQualityOfLifeGIS/QQ Norms/PopQQ.png",
      ggplot(NYCPop, aes(sample = Data)) +
         stat_qq() +
         stat_qq_line() +
         theme(axis.title.x=element_blank(),
            axis.text.x = element_blank(),
   ...
   ggsave("/Users/kamal/Documents/GitHub/NYCQualityOfLifeGIS/QQ Norms/UnemploymentRateQQ.png",
      ggplot(NYCUnemploymentRate, aes(sample = Data)) +
         stat_qq() +
         stat_qq_line() +
         theme(axis.title.x=element_blank(),
            axis.text.x = element_blank(),
   ...
   ggsave("/Users/kamal/Documents/GitHub/NYCQualityOfLifeGIS/QQ Norms/PovertyQQ.png",
      ggplot(NYCPoverty, aes(sample = Data)) +
         stat_qq() +
         stat_qq_line() +
         theme(axis.title.x=element_blank(),
            axis.text.x = element_blank(),
